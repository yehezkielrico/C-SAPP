...
Route::middleware('guest')->group(function () {
    ...
    Route::get('verify-otp', [EmailVerificationOTPController::class, 'show'])
        ->name('verification.otp.form');

    Route::post('verify-otp', [EmailVerificationOTPController::class, 'verify'])
        ->name('verification.otp.verify');

    Route::post('resend-otp', [EmailVerificationOTPController::class, 'resend'])
