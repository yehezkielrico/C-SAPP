    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative bg-[#1A2333]/30 backdrop-blur-sm rounded-xl border border-gray-800 p-6">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="mt-1 text-gray-400">Perbarui kuis pembelajaran</p>
                        </div>
            ...
            <div class="relative">
                ...
                <div class="relative bg-[#1A2333]/30 backdrop-blur-sm rounded-xl border border-gray-800 p-6">
                    <form action="{{ route('admin.quizzes.update', $quiz) }}" method="POST" class="space-y-6" id="quizForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title', $quiz->title) }}" class="block w-full pl-10 pr-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan judul kuis" required>
                            </div>
                            @error('title')
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-4">
                                <div class="flex items-center">
                                    <input type="radio" name="is_published" id="draft" value="0" {{ old('is_published', $quiz->is_published) == '0' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50" required>
                                    <label for="draft" class="ml-3 block text-sm font-medium text-gray-300">
                                        Draft
                                    </label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" name="is_published" id="published" value="1" {{ old('is_published', $quiz->is_published) == '1' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50">
                        ...
                        <div class="space-y-6" id="questions-container">
                            ...
                            @foreach($questions as $index => $question)
                                <div class="question-item">
                                    <div class="relative bg-[#1A2333]/50 rounded-lg border border-gray-700 p-6 mb-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="questions[{{ $index }}][question]" value="{{ old('questions.'.$index.'.question', $question->question) }}" class="w-full px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan pertanyaan" required>
                                </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div>
                                                    <div class="flex items-center">
                                                        <input type="radio" name="questions[{{ $index }}][correct_answer]" value="a" {{ old('questions.'.$index.'.correct_answer', $question->correct_answer) == 'a' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50" required>
                                                        <input type="text" name="questions[{{ $index }}][option_a]" value="{{ old('questions.'.$index.'.option_a', $question->option_a) }}" class="ml-2 flex-1 px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Opsi A" required>
                                                    </div>
                                                </div>
                                    <div>
                                                    <div class="flex items-center">
                                                        <input type="radio" name="questions[{{ $index }}][correct_answer]" value="b" {{ old('questions.'.$index.'.correct_answer', $question->correct_answer) == 'b' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50">
                                                        <input type="text" name="questions[{{ $index }}][option_b]" value="{{ old('questions.'.$index.'.option_b', $question->option_b) }}" class="ml-2 flex-1 px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Opsi B" required>
                                                    </div>
                                    </div>
                                    <div>
                                                    <div class="flex items-center">
                                                        <input type="radio" name="questions[{{ $index }}][correct_answer]" value="c" {{ old('questions.'.$index.'.correct_answer', $question->correct_answer) == 'c' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50">
                                                        <input type="text" name="questions[{{ $index }}][option_c]" value="{{ old('questions.'.$index.'.option_c', $question->option_c) }}" class="ml-2 flex-1 px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Opsi C" required>
                                                    </div>
                                    </div>
                                    <div>
                                                    <div class="flex items-center">
                                                        <input type="radio" name="questions[{{ $index }}][correct_answer]" value="d" {{ old('questions.'.$index.'.correct_answer', $question->correct_answer) == 'd' ? 'checked' : '' }} class="h-4 w-4 text-blue-500 border-gray-700 focus:ring-blue-500 bg-[#1A2333]/50">
                                                        <input type="text" name="questions[{{ $index }}][option_d]" value="{{ old('questions.'.$index.'.option_d', $question->option_d) }}" class="ml-2 flex-1 px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Opsi D" required>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <textarea name="questions[{{ $index }}][explanation]" rows="2" class="w-full px-3 py-2 border border-gray-700 rounded-lg bg-[#1A2333]/50 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan penjelasan jawaban yang benar">{{ old('questions.'.$index.'.explanation', $question->explanation) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
