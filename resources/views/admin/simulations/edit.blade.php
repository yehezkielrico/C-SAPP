                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <div id="steps-container" class="space-y-4">
                                ...
                                <div class="flex items-center gap-4">
                                    <input type="text" name="steps[]" class="flex-1 rounded-md bg-gray-700/50 border border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500" value="{{ $step }}" required>
                                ...
                                @endforeach
                                <div class="flex items-center gap-4">
                                    <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700" onclick="addStep()">
                        ...
                        <div>
                            ...
                            <div id="answers-container" class="space-y-4">
                                @foreach($simulation->correct_answers as $answer)
                                <div class="flex items-center gap-4">
                                    <input type="text" name="correct_answers[]" class="flex-1 rounded-md bg-gray-700/50 border border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500" value="{{ $answer }}" required>
                                    <button type="button" class="px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700" onclick="this.parentElement.remove()">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                </div>
                                @endforeach
                                <div class="flex items-center gap-4">
                                    <button type="button" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700" onclick="addAnswer()">
                                        <i class="fas fa-plus mr-2"></i>
                                        Tambah Jawaban
                                    </button>
                                </div>
