                ...
                <form action="{{ route('admin.simulations.store') }}" method="POST" class="p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="scenario" id="scenario" rows="4" class="mt-1 block w-full rounded-md bg-gray-700/50 border border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500" required>{{ old('scenario') }}</textarea>
                        ...
                        <div>
                            ...
                            <div id="steps-container" class="space-y-6">
                                <div class="step-item border border-gray-700/50 rounded-lg p-4 bg-gray-800/30" data-step-index="0">
                                    <div class="flex items-center justify-between mb-3">
                                        <h4 class="text-sm font-medium text-gray-300">Langkah 1</h4>
                                        <button type="button" class="px-2 py-1 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700" onclick="removeStep(this)" style="display: none;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="options-container space-y-2">
                                            <div class="flex items-center gap-2">
                                                <input type="text" name="options[0][]" class="flex-1 rounded-md bg-gray-700/50 border border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Opsi 1" required>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <input type="text" name="options[0][]" class="flex-1 rounded-md bg-gray-700/50 border border-gray-600 text-white focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Opsi 2" required>
                                                <button type="button" class="px-2 py-1 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700" onclick="removeOption(this)" style="display: none;">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
